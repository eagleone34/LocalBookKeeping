...
echo.
REM Use fetch + reset instead of pull. This is an updater, not a dev workflow.
REM Local changes are only build artifacts that get regenerated anyway.
git fetch origin main
if %ERRORLEVEL% NEQ 0 (
    echo.
    echo ==========================================
    echo  GIT FETCH FAILED. Check your internet
